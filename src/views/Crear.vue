      ...
      <Header />
        ...
        <div class="container" v-if="tipoRegistro === 'profesores'">
          ...
          <div class="text-center mt-5">
            <h1>Ingresar datos del Profesor</h1>
          </div>
                  ...
                  <div class="container">
                    <form id="contact-form" role="form">
                      <div class="controls">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="form_apellidoPaterno">Apellido Paterno</label>
                              <input
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="form_apellidoMaterno">Apellido Materno</label>
                              <input
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="form_numeroEmpleado">Numero de Empleado</label>
                              <input
              ...
              <div class="container">
                  ...
                  <div class="col-md-12">
                        ...
                        id="send-profesor"
                          ...
                          value="Enviar"
                          v-on:click="createRegister(registroProfesor)"
                        />
                  </div>
              </div>
                </div>
              ...
              <div class="container">
                  ...
                  <div class="col-md-12">
                        <input
                          ...
                          class="btn btn-primary btn-send pt-2 btn-block"
                          value="Enviar"
                          v-on:click="createRegister(registroAlumno)"
                        />
                  </div>
              </div>
                </div>
        ...
        <div class="container" v-else-if="tipoRegistro === 'salones'">
          <br />
          <div class="text-center mt-5">
            <h1>Ingresar datos del salon</h1>
          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <textarea id="form_comodidades" name="comodidades" class="form-control"  rows="4" required="required" data-error="Is required." v-model="registroSalon.comodidades"></textarea
                                  >
                            </div>
                          </div>
                        </div>
              ...
              <div class="container">
                  ...
                  <div class="col-md-12">
                        <input
                          ...
                          class="btn btn-primary btn-send pt-2 btn-block"
                          value="Enviar"
                          v-on:click="createRegister(registroSalon)"
                        />
                  </div>
              </div>
                </div>
        ...
        <div class="container" v-else-if="tipoRegistro === 'asignaturas'">
          <br />
          <div class="text-center mt-5">
            <h1>Ingresar datos de la asignatura</h1>
          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <textarea id="form_descripcion" name="message" class="form-control"  rows="4" required="required" data-error="Is required." v-model="registroAsignatura.descripcion"></textarea
                                  >
                            </div>
                          </div>
                        </div>
              ...
              <div class="container">
                  ...
                  <div class="col-md-12">
                        <input
                          ...
                          class="btn btn-primary btn-send pt-2 btn-block"
                          value="Enviar"
                          v-on:click="createRegister(registroAsignatura)"
                        />
                  </div>
              </div>
                </div>
...
export default {
  ...
  methods: {
    createRegister(nuevoRegistro){
        Axios.post(
            `${API_BASE_URL}/${this.tipoRegistro}`,
            nuevoRegistro,
            config
        )
        .then((data) => {
            ...
            toast.success('El registro se ha creado correctamente', {
                autoClose: 3000,
            });
